#!/usr/bin/env python3
# GRABMAP v3 - DoomXR feature-showcase ninja course, built from the swarm's validated spec.
...
# FIRING/PARRY spur. Generated geometry, validated (closure/dangling/portal/things/gutters).
