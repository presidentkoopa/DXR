...
class HealthBonus : Health
{
	Default
	{
		...
		Keywords "mass:5", "grab", "class:health", "type:pickup", "trait:restoration", "context:vitality", "weight:light";
	}
	States
	{
	Spawn:
...
class Stimpack : Health
{
	Default
	{
		...
		Keywords "mass:10", "grab", "class:health", "type:pickup", "trait:restoration", "context:vitality", "weight:light";
	}
	States
	{
	Spawn:
