// ============================================================================
//  GITD_ScoreBurst -- the kill-reward score display. Spawned by a combo's
//  Bank() at the spot where the chain ended. The final score's digits CONVERGE
...
class GITD_ScoreBurst : Actor
{
	...
	override void Tick()
	{
		...
		for (int i = 0; i < n; i++)
		{
			int digit = (score / Pow10(n - 1 - i)) % 10;
