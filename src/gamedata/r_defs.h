...
public:
	...
	float WallGlowHeight = 0;             // radius
	double WallGlowX = 0, WallGlowY = 0;  // spot center (game coords)

	PalEntry GetWallGlowColor() const { return WallGlowColor; }
	double GetWallGlowHeight() const { return WallGlowHeight; }
	double GetWallGlowX() const { return WallGlowX; }
	double GetWallGlowY() const { return WallGlowY; }
	void SetGlowSpot(PalEntry color, float radius, double x, double y)
	{
		WallGlowColor = color; WallGlowHeight = radius; WallGlowX = x; WallGlowY = y;
	}
