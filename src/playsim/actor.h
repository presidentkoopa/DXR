...
class AActor final : public DThinker
{
	...
	HAS_OBJECT_POINTERS
public:
    FVRTaxonomy* vr_taxonomy = nullptr;
	KeywordProfile vr_metadata;
    struct VRWeaponData* vr_weapon_data = nullptr;
	AActor() = default;
...
// interaction info
	...
	float msdf_enabled = 0.0f;
	float msdf_glitch = 0.0f;
	FVector3 msdf_color = { 1.0f, 1.0f, 1.0f };
