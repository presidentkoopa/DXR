...
bool FShader::Load(const char * name, const char * vert_prog_lump, const char * frag_prog_lump, const char * proc_prog_lump, const char * light_fragprog, const char * defines)
{
	...
	FString i_data = R"(
		...
		uniform vec4 uWallGlowSpots[MAX_WALL_GLOW_SPOTS];
		uniform int uWallGlowSpotCount;
		uniform vec4 uWallGlowMask[MAX_WALL_GLOW_SPOTS];
		...
		// Wallet and Score for VR UI
		uniform int uWalletValue;
		uniform int uScoreValue;
...
//
	...
	muWalletValue.Init(hShader, "uWalletValue");
	muScoreValue.Init(hShader, "uScoreValue");
	...
	muWallGlowSpots.Init(hShader, "uWallGlowSpots");
	muWallGlowSpotCount.Init(hShader, "uWallGlowSpotCount");
	muWallGlowMask.Init(hShader, "uWallGlowMask");
