...
public:
	...
	void Set(const float *newvalue, int count)
	{
		glUniform4fv(mIndex, count, newvalue);
	}
...
public: class ShaderVariantData
	...
	public:
		...
		FBufferedUniform1i muVisualRegime;
		FBufferedUniform1i muArcadeCRT;
		FBufferedUniform1i muAffineWarp;
		/////
		...
		FUniform4f muWallGlowSpots;
		FBufferedUniform1i muWallGlowSpotCount;
		FUniform4f muWallGlowMask;
