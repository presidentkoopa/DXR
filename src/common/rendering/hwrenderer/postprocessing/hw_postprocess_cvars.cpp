...
// VR "Wired" Regimes and Effects
CVAR(Int, vr_visual_regime, 0, CVAR_ARCHIVE | CVAR_GLOBALCONFIG)
CVAR(Bool, vr_arcade_crt, false, CVAR_ARCHIVE | CVAR_GLOBALCONFIG)
CVAR(Bool, vr_affine_warp, false, CVAR_ARCHIVE | CVAR_GLOBALCONFIG)
CVAR(Bool, vr_data_haze, false, CVAR_ARCHIVE | CVAR_GLOBALCONFIG)
CVAR(Float, vr_data_haze_density, 1.0f, CVAR_ARCHIVE | CVAR_GLOBALCONFIG)
